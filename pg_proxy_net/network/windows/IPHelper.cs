...
namespace pg_proxy_net.network.windows
{
    ...
    public class IPHelper
    {
        ...
        // Tcp Struct
        public MIB_TCPTABLE _TcpConnection;
        public MIB_TCPSTATS TcpStats;
        public MIB_EXTCPTABLE _TcpExConnections;
        public MIB_EXTCPTABLE _Internal_TcpExConnections;


        // Udp Struct
        public MIB_UDPSTATS UdpStats;
        public MIB_UDPTABLE _UdpConnection;
        public MIB_EXUDPTABLE _UdpExConnection;
        ...
        public void _GetExTcpConnections()
        {
            try
            {
                ...
                _TcpExConnections = new MIB_EXTCPTABLE();
                _Internal_TcpExConnections = new MIB_EXTCPTABLE();
                // Allocate memory
        ...
        public void _GetTcpConnections()
        {
            try
            {
                ...
                _TcpConnection = new MIB_TCPTABLE();
        ...
        public void _GetUdpConnections()
        {
            try
            {
                ...
                _UdpConnection = new MIB_UDPTABLE();
        ...
        public void _GetExUdpConnections()
        {
            try
            {
                ...
                BufferSize = (NumEntries * rowsize) + 4;
                // make the struct to hold the resullts
                _UdpExConnection = new MIB_EXUDPTABLE();
                // Allocate memory
                lpTable = Marshal.AllocHGlobal(BufferSize);

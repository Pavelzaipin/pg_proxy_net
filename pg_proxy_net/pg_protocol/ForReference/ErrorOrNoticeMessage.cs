                ...
                switch (fieldCode)
                {
                    ...
                    case ErrorFieldTypeCode.Detail:
                        ...
                        if (!includeDetail && !string.IsNullOrEmpty(detail))
                            ...
                            detail = $"Detail redacted as it may contain sensitive data. Specify IncludeExceptionDetailDisplayName in the connection string to include this information.";
                        break;
                    ...
                    case ErrorFieldTypeCode.Position:
                        ...
                        {
                            System.Console.WriteLine("Non-numeric position in ErrorResponse: " + positionStr);
                            continue;
                        }
                    ...
                    case ErrorFieldTypeCode.InternalPosition:
                        ...
                        {
                            System.Console.WriteLine("Non-numeric position in ErrorResponse: " + internalPositionStr);
                            continue;
                        }
